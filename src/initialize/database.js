...
const main = async () => {
    ...
    await FullTime.bulkCreate([
        {
            id: 1, /////
            jobDes: 'รายละเอียดงาน \nทำงานคลินิกทั่วไป \nตรวจนักท่องเที่ยวต่างชาติ \nคุณสมบัติผู้สมัคร \n• จบแพทย์สาสตร์บัณฑิต \n• มีใบประกอบโรคศิลป์',
        ...
        },
        {
            ...
            salary: '120000',
            annual: '10',
            benefit: '- วันหยุดพักผ่อนประจำปี- ประกันสุขภาพ ประกันชีวิต- ประกันสังคม- กองทุนสำรองเลี้ยงชีพ- ตรวจสุขภาพประจำปี',
            other: 'ไม่มี',
            jobPostId: 9,
        },
        {
